...
<div class="min-h-full">
  <nav class="bg-yellow-900">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-10" src="https://img.icons8.com/carbon-copy/100/under-computer.png" alt="Your Company" />
          </div>
            ...
            <div class="relative ml-3">
              <div>
                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="size-8 rounded-full" src="https://img.icons8.com/?size=100&id=oO0pZgktLNpK&format=png&color=000000" alt="" />
                </button>
              </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://img.icons8.com/?size=100&id=oO0pZgktLNpK&format=png&color=000000" alt="" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Shiva Naidu</div>
            <div class="text-sm font-medium text-gray-400">dasarisambasivanaidu7@gmail.com</div>
          </div>
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:items-center sm:justify-between">
      <h1 class="text-3xl font-bold tracking-tight text-gray-700">{{ $heading }}</h1>
